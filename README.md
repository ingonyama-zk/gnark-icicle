...
For more information about prerequisites see the [ICICLE repo](https://github.com/ingonyama-zk/icicle-gnark). **NB! ICICLE CUDA kernels are covered by a special license for now. Follow the instructions to download and set up the kernels.**
